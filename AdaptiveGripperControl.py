...
class RobotiqGripper:
    ...
    def connect(self, hostname: str = "192.168.1.5", port: int = 63352, socket_timeout: float = 2.0) -> None:
    ...
    def open(self):
        self.move_and_wait_for_pos(0, 50, 0)

    def close(self):
        self.move_and_wait_for_pos(255, 50, 100)
